...
android { namespace="com.personal.alertengine"; compileSdk=35
    defaultConfig { applicationId="com.personal.alertengine"; minSdk=26; targetSdk=35; versionCode=2; versionName="0.2.0" }
